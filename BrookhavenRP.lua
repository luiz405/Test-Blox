...
CreateButton(TabTools, "Invisibility (Invis)", function()
    local c = GetChar()
    if c then
...
CreateButton(TabMisc, "Re-Executar Script", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/luiz405/Test-Blox/main/BrookhavenRP.lua"))()
end)
